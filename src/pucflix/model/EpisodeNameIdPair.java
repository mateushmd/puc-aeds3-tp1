...
public class EpisodeNameIdPair implements RegistroArvoreBMais<EpisodeNameIdPair> {
    private String name;
    private int id;
    private short SIZE = 104;
    private short NAME_SIZE = 100;

    public EpisodeNameIdPair() throws Exception
    {
        this("", -1);
    }

    public EpisodeNameIdPair(String name) throws Exception
    {
        this(name, -1);
    }

    public EpisodeNameIdPair(String name, int id) throws Exception
    {
        this.name = "";
        this.id = id;
    ...
    {
        try { return new EpisodeNameIdPair(name, id); }
    ...
    public int compareTo(EpisodeNameIdPair other)
    {
